...
export const WorkflowRow = memo(function WorkflowRow({ flow }: { flow: FluxEntry }) {
    return (
        <div className="group relative flex h-9 items-center gap-2.5 rounded-md px-2 transition-colors hover:bg-accent/60">
            ...
            <button type="button" className="min-w-0 flex-1 text-left outline-none" title={flow.path}>
            ...
            <Button
                ...
                className="relative z-10 size-6 shrink-0 text-muted-foreground opacity-0 transition-opacity group-focus-within:opacity-100 group-hover:opacity-100 hover:text-destructive"
            >
