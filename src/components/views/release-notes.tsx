    ...
    <div className="app-scroll h-full overflow-y-auto">
      <article className="mx-auto w-full max-w-2xl px-6 py-12 lg:px-8">
        ...
        <p className="text-[15px] leading-relaxed text-muted-foreground text-pretty">
          Esta versión se centra en hacer que Flux se sienta como una
          aplicación de escritorio nativa de primera clase. Reconstruimos el
          shell de la interfaz desde cero, con un sistema de pestañas y un
        ...
        <p className="text-sm text-muted-foreground text-pretty">
          ¿Tienes comentarios? Comparte tus ideas en el repositorio del proyecto
          o únete a la conversación en la comunidad. Gracias por usar Flux.
        </p>
      </article>
    </div>
  )
