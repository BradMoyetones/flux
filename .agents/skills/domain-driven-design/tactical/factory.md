...
class Order {
    ...
    static reconstitute(id: OrderId, customerId: CustomerId, items: OrderItem[], status: OrderStatus): Order {
...
class Order {
    ...
    static reconstitute(id: OrderId, items: OrderItem[], status: OrderStatus, placedAt: Date): Order {
