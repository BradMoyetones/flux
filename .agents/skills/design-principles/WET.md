...
class DataExporter<T> {
    ...
    private toCsv(data: T[], options: ExportOptions): Buffer {
        /* 100 lines */
    }
    private toJson(data: T[], options: ExportOptions): Buffer {
        /* 50 lines */
    }
    private toXml(data: T[], options: ExportOptions): Buffer {
        /* 80 lines */
    }
    private toPdf(data: T[], options: ExportOptions): Buffer {
        /* 150 lines */
    }
}
