...
# Flux v2.0.0 - The Automation Engine Update
...
* **Manejo de Errores Unificado (`AppError`):** El sistema nunca hace *panic*. Todo error (HTTP, Storage, WhatsApp o Scheduler) es capturado, categorizado y emitido al frontend de forma elegante.
